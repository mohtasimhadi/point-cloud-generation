        ...
        for q in qs:
            ...
            if new_msg is not None:
                ...
                if msgs:
                    ...
                    cv2.imwrite(OUT_DIR+f"{serial_no}_{timestamp.strftime('%H:%M:%S.%f')}_depth.png", depth)
                    cv2.imwrite(OUT_DIR+f"{serial_no}_{timestamp.strftime('%H:%M:%S.%f')}_rgb.png", rgb)
